 ...
 */
public class ElasticsearchEntityMapperTests {
	...
	public void init() {
		...
		t800AsMap.put("_class", "org.springframework.data.elasticsearch.core.ElasticsearchEntityMapperTests$Person");

		gratiotAve = new Address();
		gratiotAve.city = "Los Angeles";
		gratiotAve.street = "2800 East Observatory Road";
		gratiotAve.location = new Point(34.118347D, -118.3026284D);

		sarahAsMap = new LinkedHashMap<>();
		sarahAsMap.put("id", "sarah");
		sarahAsMap.put("name", "Sarah Connor");
		sarahAsMap.put("gender", "MAN");
		sarahAsMap.put("_class", "org.springframework.data.elasticsearch.core.ElasticsearchEntityMapperTests$Person");
	...
	public void writeMapOfConcreteType() {
		...
		sarahConnor.shippingAddresses.put("home", gratiotAve);
	...
	public void readConcreteMapCorrectly() {
		...
		assertThat(target.getShippingAddresses()).hasSize(1).containsEntry("home", gratiotAve);
	}
	...
	public void readsNestedEntity() {
		...
		assertThat(target.getAddress()).isEqualTo(gratiotAve);
	}
